...
public class StringUtils extends org.apache.commons.lang.StringUtils{
    ...
    public static String UrlEncode(String value, String encodeType)
    {
        try
        {
            value = URLEncoder.encode(value, encodeType);
            return value;
        }
        catch(UnsupportedEncodingException e)
        {
    ...
    public static String UrlDecode(String value, String encodeType)
    {
        try
        {
            value = URLDecoder.decode(value, encodeType);
            return value;
        }
        catch(UnsupportedEncodingException e)
        {
